...
try {
    ...
    assert.equal("Pet's Name: Fido\nFavorite Movie: The Good, the Bad and the Ugly", value);
    const restartButton = await driver.findElement(By.xpath('//button[text()="Restart"]'));
...
async function testAccessibility() {
    ...
    const alfaPage = Page.of(Request.empty(), Response.empty(), Document.from(documentJSON, device), device);
